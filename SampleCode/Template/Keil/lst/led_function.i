...
#line 4 "..\\LED_Function.c"
#line 1 "..\\LED_Function.h"
...
#line 216 "..\\LED_Function.h"


#line 234 "..\\LED_Function.h"


#line 252 "..\\LED_Function.h"


#line 270 "..\\LED_Function.h"


#line 288 "..\\LED_Function.h"


#line 306 "..\\LED_Function.h"


#line 324 "..\\LED_Function.h"


#line 342 "..\\LED_Function.h"


#line 360 "..\\LED_Function.h"


#line 378 "..\\LED_Function.h"


#line 396 "..\\LED_Function.h"


#line 414 "..\\LED_Function.h"
...
void SpiLED_TX_PDMA(uint8_t idx , uint8_t* Tx , uint16_t len)
{
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1 << (12)));

	
    PDMA_SetTransferCnt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(12), 0x00000000UL, len);
     
    PDMA_SetTransferAddr(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(12), (uint32_t)Tx, 0x00000000UL, (uint32_t)&(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->TX, 0x00000C00UL);
     
	
    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(12), 22UL, (0UL), 0);
	
     
    PDMA_SetBurstType(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(12), 0x00000004UL, 0x00000000UL);
     
    ((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[(12)].CTL |= (0x1ul << (7));

    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->PDMACTL |= (0x1ul << (0)));
    ...
    while(1)
    {
        ...
        if(u32RegValue & (0x1ul << (1)))
        {
            ...
            if((((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & (1 << (12))) == (1 << (12)))
            {
                 
                ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = (1 << (12))));
				...
				switch(idx)
				{
					case SPI_LED0:
						...
						break;
					case SPI_LED1:
						((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((7)<<2)))) = 1);		
						break;
					case SPI_LED2:
						((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((11)<<2)))) = 1);		
						break;
					case SPI_LED3:
						((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((1)<<2)))) = 1);		
						break;
					case SPI_LED4:
						((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((0)<<2)))) = 1);		
						break;	
				}
...
void SpiLED_Init(void)
{
    ...
    SPI_Open((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))), (0x0U), ((0x1ul << (2))), 8, (200000));

    SYS_UnlockReg();	
	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~( (0xful << (24)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |=  (0x00UL<<(24));	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)),(0x00000040UL),0x1UL);	

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~( (0xful << (28)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |=  (0x00UL<<(28));	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)),(0x00000080UL),0x1UL);	

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH &= ~( (0xful << (12)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH |=  (0x00UL<<(12));	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)),(0x00000800UL),0x1UL);	

#line 132 "..\\LED_Function.c"

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH &= ~( (0xful << (24)));	
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPH |=  (0x00UL<<(24));	
...
{		
	...
	switch(idx)
	{
		case SPI_LED0:
			...
			break;
		case SPI_LED1:
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((7)<<2)))) = 0);		
			break;
		case SPI_LED2:
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((11)<<2)))) = 0);		
			break;
		case SPI_LED3:
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((1)<<2)))) = 0);		
			break;
		case SPI_LED4:
			((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(5))) + ((0)<<2)))) = 0);		
			break;	
	}


    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = ((0x20|bPage)));
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = (bRegAddr));
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = (bData));
	...
	bDummyRead = (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->RX);
	bDummyRead = (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->RX);
	bDummyRead = (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->RX);
...
{	
	...
	while(!((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->STATUS & (0x1ul << (16)))>>(16)));
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = ((0xA0|bPage)));
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = (bRegAddr));	
	...
	for(i = 0;i < blength;i++)
	{
    	(((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = (0));		
		while(( (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->STATUS & (0x1ul << (0)))>>(0) ));
		while(((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->STATUS & (0x1ul << (8)))>>(8)));
		
		b_arySPI_Rx_FIFO[i] = (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->RX);
	}
...
void LED_SNLED2735Init(uint8_t idx)
{
	...
	((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(2))) + ((14)<<2)))) = 1);
	
    CLK_SysTickDelay(25000);
	
	
	
	SPI_W_3BYTE(idx, 0X03,0X00, (0x0<<0));
	
	SPI_W_3BYTE(idx, 0X03,0x13, 0xAA);
	
	SPI_W_3BYTE(idx, 0X03,0x14, 0x00);
	
	SPI_W_3BYTE(idx, 0X03,0x15, 0x04);
	
	SPI_W_3BYTE(idx, 0X03,0x16, 0xC0);
	
	SPI_W_3BYTE(idx, 0X03,0x1A, 0x00);	
	...
	SPI_W_NBYTE(idx, 0X01, 0x00, 0xC0);
	
	
	
	
	b_arySPI_Tx_FIFO[0] = 0x80;
	b_arySPI_Tx_FIFO[1] = 0x80;
	b_arySPI_Tx_FIFO[2] = 0x80;
	b_arySPI_Tx_FIFO[3] = 0x80;
	b_arySPI_Tx_FIFO[4] = 0x80;
	b_arySPI_Tx_FIFO[5] = 0x80;
	b_arySPI_Tx_FIFO[6] = 0x80;
	b_arySPI_Tx_FIFO[7] = 0x80;
	b_arySPI_Tx_FIFO[8] = 0x80;
	b_arySPI_Tx_FIFO[9] = 0x80;
	b_arySPI_Tx_FIFO[10] = 0x80;
	b_arySPI_Tx_FIFO[11] = 0x80;
	SPI_W_NBYTE(idx, 0X04, 0x00, 0x0C);
	...
	SPI_W_3BYTE(idx, 0X03,0X00, (0x1<<0));
}
...
{
	SPI_R_NBYTE(idx, 0X03, 0x11, 1);
	if(b_arySPI_Rx_FIFO[0]==0x8A)
	{
		return 0x01;
	}
	else
...
void LED_SW_SLEEP(uint8_t idx)
{
	...
	SPI_W_3BYTE(idx, 0X03,0x1A, 0x02);
...
const uint8_t	b_tabLED_Control_Map[24]=
{
  ...
  ((0x01U<<0)|(0x01U<<1)|(0x01U<<2)|(0x01U<<3)|(0x01U<<4)|(0x01U<<5)|(0x01U<<6)|(0x01U<<7)), 
  ((0x01U<<0)|(0x01U<<1)|(0x01U<<2)|(0x01U<<3)|(0x01U<<4)|(0x01U<<5)|(0x01U<<6)|(0x01U<<7)),
...
void LED_SnledType4Fun2(uint8_t idx)
{
	...
	for( i = 0; i< 0x18 ; i++)
	{
		b_arySPI_Tx_FIFO[i] = b_tabLED_Control_Map[i];	
	}
	SPI_W_NBYTE(idx, 0X00, 0x0, 0x48);
