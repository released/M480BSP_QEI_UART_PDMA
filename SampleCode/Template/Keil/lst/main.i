...
void compare_buffer(uint8_t *src, uint8_t *des, int nBytes)
{
    ...
    for (i = 0; i < nBytes; i++)
    {
        if (src[i] != des[i])
        {
			...
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_compare_error))) : ((BitFlag&=~(uint32_t)(1<<flag_compare_error))));
        }
    }

	if (!(((BitFlag&(uint32_t)(1<<flag_compare_error))?1:0)))
	{

    	printf("%s finish \r\n" , __FUNCTION__);	

		( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_compare_error))) : ((BitFlag&=~(uint32_t)(1<<flag_compare_error))));
	}
...
void UART_TX_PDMA(uint8_t* Datain , uint16_t len)
{
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), ((1 << (11))));

	
    PDMA_SetTransferCnt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(11), 0x00000000UL, len);
     
    PDMA_SetTransferAddr(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(11), (uint32_t) (&Datain[0]), 0x00000000UL, (uint32_t) &((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL))->DAT , 0x00000C00UL);
     
	
    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(11), 14UL, (0UL), 0);

    PDMA_SetBurstType(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(11), 0x00000004UL, 0x00000000UL);
     
    ((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[(11)].CTL |= (0x1ul << (7));

	((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->INTEN |= ((0x1ul << (14))));
    ...
    while(1)
    {
        ...
        if(u32RegValue & (0x1ul << (1)))
        {
            ...
            if((((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & ((1 << (11)))) == ((1 << (11))))
            {
                 
                ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = (((1 << (11))))));
				((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->INTEN &= ~((0x1ul << (14))));				
                break;
            }
        }
...
void QEI0_Process(void)
{
	...
	char str[32];
	uint8_t dir = (((((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)))->STATUS & ((0x1ul << (8))))?1:0);
	uint16_t value = ((((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)))->CNT);

	if ((((BitFlag&(uint32_t)(1<<flag_UART_PDMA))?1:0)))
	{
		( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART_PDMA))) : ((BitFlag&=~(uint32_t)(1<<flag_UART_PDMA))));
...
void QEI0_Init(void)
{
	QEI_Open(((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)), (0x0<<(8)), 0xFFFF);

    QEI_Start(((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)));
}
...
void TMR1_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))) == 1)
    {
		...
		{		
			...
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART_PDMA))) : ((BitFlag&=~(uint32_t)(1<<flag_UART_PDMA))));
...
void SYS_Init(void)
{
    ...
    CLK_EnableXtalRC((0x1ul << (0))|(0x1ul << (2))|(0x1ul << (3)));

     
    CLK_WaitClockReady((0x1ul << (0))|(0x1ul << (4))|(0x1ul << (3)));
    ...
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(30UL<<20) |(3UL<<18) |(0xFUL<<10) |(12UL<<5) |(21UL<<0)), (0x3UL << (30)), (((1) - 1UL) << (12)));
	...
	CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)), (0x7UL << (8)), 0);
    ...
    CLK_EnableModuleClock(((2UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(22UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (20))  );
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= ((0x08UL<<(20)) );

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (16)) | (0xful << (12)) );
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= ((0x0EUL<<(16)) | (0x0EUL<<(12)) );
